...
export default function ContactComponent() {
    return (
        ...
        mr-4 ml-4 mb-40 mt-20 h-full " id="contact">
            <h1 className="text-center text-2xl md:text-4xl font-head1Main ">Contact</h1>
            <p className="text-center text-rosyblack my-5">Get in touch with me</p>
            <form className="flex flex-col items-center" 
            action="https://formspree.io/f/mayzpeqw" method="POST">
              <div >
                <input
