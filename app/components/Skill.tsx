    ...
    <div className="md:pt-10 mr-4 ml-4  mb-40 md:mb-20 h-auto shadow-lg shadow-black" 
     >
      <div className="text-rosyblack px-10    ">
        <h3 id="skill" className="text-center font-head1Main 
        text-2xl md:text-4xl mb-10 ">
          Soft Skills</h3>
        <div className="text-rosyblack p-4  grid grid-cols-1 sm:grid-col-2
        md:grid-cols-3 gap-4">
        {soft.map((sk, i) => {
           img = `/${sk.icon}`
          return (
            <div key={i} className=" flex justify-center items-center  ">
              <div className="flex flex-col font-head2Main items-center
               p-2 shadow-md  h-40 w-60 hover:scale-105 duration-75 ">
               <Image alt="" src={img} width={80} height={80} 
        ...
        md:grid-cols-3 gap-4">
         ...
         return (
              <div key={i} className="   flex justify-center items-center  ">
                <div className="flex flex-col font-head2Main items-center
               p-2 shadow-md  h-40 w-60 hover:scale-105 duration-75  ">
                <Image  alt="" src={img} width={80} height={80} className="text-4xl 
                flex justify-center items-center"/>
                   <p className="text-lg flex justify-center items-center">{hsk.text}</p>
                </div>
